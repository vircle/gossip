...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gossip_address\> \<monthly_payment_gossip\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GOSSIP, _12_ times over the course of a year totaling _24000_ GOSSIP.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gossip_address\> \<monthly_payment_gossip\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GOSSIP.
