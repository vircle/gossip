...
In order to support loading of multiple wallets in gossip-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gossip.cpp.
...
Changes to gossip.cpp
----------------------
gossip.cpp is the entry point into gossip-qt, and as such, will require some minor modifications to provide hooks for
