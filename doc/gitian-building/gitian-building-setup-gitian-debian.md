...
Clone the git repositories for gossip and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/g0ssipcoin/GossipCoinCore
git clone https://github.com/g0ssipcoin/gitian.sigs.git
