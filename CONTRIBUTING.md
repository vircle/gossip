Contributing to GOSSIP Core
============================

The GOSSIP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GOSSIP Core project, and is not to be
confused with overall GOSSIP Network Protocol consensus changes.

Whether a pull request is merged into GOSSIP Core rests with the project merge
...
Patches that change GOSSIP consensus rules are considerably more involved than
...
Where a patch set proposes to change the GOSSIP consensus, it must have been
...
The project leader is the release manager for each GOSSIP Core release.
