...
RESOURCES += src/qt/gossip.qrc src/qt/gossip_locale.qrc

TRANSLATIONS += src/qt/locale/gossip_bg.ts \
                src/qt/locale/gossip_de.ts \
                src/qt/locale/gossip_en.ts \
                src/qt/locale/gossip_es.ts \
                src/qt/locale/gossip_fi.ts \
                src/qt/locale/gossip_fr.ts \
                src/qt/locale/gossip_it.ts \
                src/qt/locale/gossip_ja.ts \
                src/qt/locale/gossip_pl.ts \
                src/qt/locale/gossip_pt.ts \
                src/qt/locale/gossip_ru.ts \
                src/qt/locale/gossip_sk.ts \
                src/qt/locale/gossip_sv.ts \
                src/qt/locale/gossip_vi.ts \
                src/qt/locale/gossip_zh_CN.ts \
                src/qt/locale/gossip_zh_TW.ts
