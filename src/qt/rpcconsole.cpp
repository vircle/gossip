                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzgossPathCustom = GetArg("-zgossbackuppath", "");
    ...
    if(!strzgossPathCustom.empty()) {
        ui->wallet_customzgossbackuppath->setText(QString::fromStdString(strzgossPathCustom));
        ui->wallet_customzgossbackuppath_label->setVisible(true);
        ui->wallet_customzgossbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzgossPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GOSSIP RPC console.") + "<br>" +
