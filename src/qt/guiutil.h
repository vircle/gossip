...
/** Utility functions used by the GOSSIP Qt UI.
 */
namespace GUIUtil
{
...
// Render GOSSIP addresses in monospace font
...
// Parse "gossip:" URI into recipient object, return true on successful parsing
