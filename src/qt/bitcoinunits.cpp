...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case GOSS:
        return QString("gossip");
    case mGOSS:
        return QString("mgossip");
    case uGOSS:
        return QString::fromUtf8("ugossip");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GOSS:
            return QString("GOSS");
        case mGOSS:
            return QString("Milli-GOSS (1 / 1" THIN_SP_UTF8 "000)");
        case uGOSS:
            return QString("Micro-GOSS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
