...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GOSSIP Core gossip-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gossip-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gossip transaction") + "\n" +
                               "  gossip-tx [options] -create [commands]   " + _("Create hex-encoded gossip transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gossip transaction
