...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GOSSIP features */
        {"gossip", "masternode", &masternode, true, true, false},
        {"gossip", "listmasternodes", &listmasternodes, true, true, false},
        {"gossip", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"gossip", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"gossip", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"gossip", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gossip", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gossip", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gossip", "masternodedebug", &masternodedebug, true, true, false},
        {"gossip", "startmasternode", &startmasternode, true, true, false},
        {"gossip", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gossip", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gossip", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gossip", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gossip", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gossip", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gossip", "mnbudget", &mnbudget, true, true, false},
        {"gossip", "preparebudget", &preparebudget, true, true, false},
        {"gossip", "submitbudget", &submitbudget, true, true, false},
        {"gossip", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gossip", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gossip", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gossip", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gossip", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gossip", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gossip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gossip", "checkbudgets", &checkbudgets, true, true, false},
        {"gossip", "mnsync", &mnsync, true, true, false},
        {"gossip", "spork", &spork, true, true, false},
        {"gossip", "getpoolinfo", &getpoolinfo, true, true, false},
        {"gossip", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzgossseed", &getzgossseed, false, false, true},
        {"zerocoin", "setzgossseed", &setzgossseed, false, false, true}
...
{
    return "> gossip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23679/\n";
}
