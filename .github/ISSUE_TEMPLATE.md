...
This issue tracker is only for technical issues related to GOSSIP Core.
General GOSSIP questions and/or support requests and are best directed to the [GOSSIP Discord](https://discord.gg/54vDcgX).
...
### What version of GOSSIP Core are you using?
