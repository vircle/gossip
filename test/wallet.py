...
#   c) node1 mines 32 blocks, so now node 0 has 60001 G0ss, node 1 has 4250 G0ss, node2 has none.
#   d) node0 sends 601 phr to node2, in two transactions (301 G0ss, then 300 G0ss).
